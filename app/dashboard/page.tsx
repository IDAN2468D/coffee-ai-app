                    ...
                    <div className="flex items-center space-x-6 space-x-reverse">
                        <div className="text-right">
                            ...
                            <div className="flex items-center space-x-2 space-x-reverse text-[#8B4513]">
                                ...
                                <span className="text-2xl font-black">{stats?.points} נק׳</span>
                            </div>
                        </div>
            ...
            <div className="max-w-7xl mx-auto px-6 -mt-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
                    {[
                        ...
                        { label: 'הזמנות', value: stats?.totalOrders, icon: ShoppingBag, color: 'bg-green-500' },
                        { label: 'רמת מיומנות', value: 'בריסטה II', icon: TrendingUp, color: 'bg-purple-500' },
                    ].map((item, idx) => (
                        <motion.div
                            key={idx}
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                    ...
                    <div className="lg:col-span-2 space-y-8 text-right">
                        <div className="flex items-center justify-between flex-row-reverse">
                            <h2 className="text-2xl font-serif font-bold text-[#2D1B14]">אוסף ה-AI שלך</h2>
                            <Link href="/ai-barista" className="text-xs font-bold uppercase tracking-widest text-[#8B4513] hover:underline flex items-center flex-row-reverse">
